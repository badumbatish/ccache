...
in, including the directory of the including file. A result is only used if none
of those paths exist. Still, ccache can't check with 100% accuracy if the
existence of a new header file should invalidate a result. In practice, the
